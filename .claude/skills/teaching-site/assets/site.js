...
// ---------------------------------------------------------------------------
// EDIT THIS ARRAY — it is the only part of this file you need to change.
// It defines the site's structure and drives the sidebar, the prev/next links
// and the top-bar breadcrumb on every page. `slug` must match each page's
// filename (without .html) and its <body data-page> attribute.
// ---------------------------------------------------------------------------
const CHAPTERS = [
  { group: "Start here" },
